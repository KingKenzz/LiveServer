  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    if (downloadButton) {
        downloadButton.addEventListener('click', function() {
            var pdfFiles = [
                { url: './assets/pdf/Brochure PEMI PARTS CORP 2020.pdf', name: 'PEMI PARTS complete supplier list.pdf' },
                { url: './assets/pdf/Vestas Aircoil Company Presentation 2023.pdf', name: 'Vestas Aircoil Company Presentation 2023.pdf' }
            ];
            alert("Allow multiple download to view our full catalog");
